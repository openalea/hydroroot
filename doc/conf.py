...
author = u'Christophe Pradal, Yann Boursiac, Fabrice Bauget, Mikael Lucas, Christophe Godin, Christophe Maurel'
...
htmlhelp_basename = 'hydroroot_documentation'

# -- Options for LaTeX output ---------------------------------------------
latex_elements = {
}
latex_documents = [
    (master_doc, 'hydroroot.tex', u'hydroroot Documentation',
...
man_pages = [
    (master_doc, 'hydroroot', u'hydroroot Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'hydroroot', u'hydroroot Documentation',
     author, 'hydroroot', 'OpenAlea.HydroRoot is a hydraulic root architecture modelling and a root architecture system generator package.',
     'Miscellaneous'),
]
